 ...
 * Category
 */
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2018-09-21T12:10:20.804Z[GMT]")public class Category   {
  @JsonProperty("id")
   ...
   **/
  @JsonProperty("name")
  @Schema(example = "metabolic", description = "")
